      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="flex justify-center mt-8">
            <Link
              to="/ascenc/tools"
              className="inline-flex items-center gap-2 px-6 py-2 bg-gray-100 dark:bg-zinc-800 text-gray-800 dark:text-zinc-200 rounded-lg shadow hover:shadow-md hover:bg-gray-200 dark:hover:bg-zinc-700 transition-all duration-300 border border-gray-200 dark:border-zinc-700 font-extrabold text-sm"
            >
              <ArrowLeft className="w-5 h-5" />
              <span>{(t('paicacv.back') || t('paimt.back') || "Voltar")} - ASCENC</span>
            </Link>
          </div>
        </section>
      </div>
