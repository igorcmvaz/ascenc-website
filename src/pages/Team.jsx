    ...
    <PageLayout title={t('team.title')}>
      <div className="space-y-10 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 bg-white dark:bg-slate-200 border border-slate-300 dark:border-slate-300 p-6 sm:p-8 rounded-3xl shadow-md space-y-6 flex flex-col justify-between">
            <div>
          ...
          <div className="lg:col-span-8 bg-white dark:bg-slate-200 border border-slate-300 dark:border-slate-300 p-6 sm:p-8 rounded-3xl shadow-md space-y-8 flex flex-col justify-between">
            <div>
              <h2 className="text-xl sm:text-2xl font-black text-slate-900 border-b border-slate-300 pb-3 mb-6">
        ...
        <div className="bg-white dark:bg-slate-200 border border-slate-300 dark:border-slate-300 p-6 sm:p-8 rounded-3xl shadow-md space-y-6">
          <h2 className="text-xl sm:text-2xl font-black text-slate-900 border-b border-slate-300 pb-3">
            {t('team.ex_members')}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {formerMembers.map((member, index) => (
              <div key={index} className="bg-white dark:bg-slate-100 p-3.5 rounded-xl border border-slate-300 flex items-center justify-between gap-4 shadow-sm hover:shadow-md transition-shadow">
