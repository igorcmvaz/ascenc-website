...
export default function GESContact() {
  const { t } = useTranslation();

  return (
    <PageLayout title={t("ges_contact.title")}>
      <div className="max-w-xl mx-auto bg-slate-100 dark:bg-slate-200 border border-emerald-200 dark:border-slate-300 shadow-md rounded-2xl p-6 sm:p-8">
        ...
        <form
          ...
          className="space-y-5"
        >
          {/* Identificador para o FormSubmit saber de qual portal veio */}
          <input type="hidden" name="_subject" value="Contato - Portal Espaço Sustentável" />
